...
public class Doc {
        ...
        public static void main(String[] args) throws Exception {
        	String docxPath = "C:\\Users\\hzq\\Desktop\\To\\test.docx";
    		String htmlPath = "C:\\Users\\hzq\\Desktop\\To\\test.html";
    		String pdfPath = "C:\\Users\\hzq\\Desktop\\To\\test.pdf";
                //String localPath = System.getProperty("user.dir") + "/LineSpacing.doc";

                WordprocessingMLPackage out = convert(new FileInputStream(docxPath));

                 String outputfilepath = "E://testdocx.docx";
                
                 SaveToZipFile saver = new SaveToZipFile(out);
                 saver.save(pdfPath);
                 log.info("Done - saved docx as " + docxPath);
